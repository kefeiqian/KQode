...
- Never write into fetched reference repositories.

## Fetch policy

v1 fetches catalog repositories only.
...
- <a id="ref-2"></a>[2] Aider: coder message loop ([code](https://github.com/Aider-AI/aider/blob/def5678/aider/coders/base_coder.py#L100-L118)).
